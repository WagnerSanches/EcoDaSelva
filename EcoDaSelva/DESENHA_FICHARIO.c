...
void desenhar_box(struct Fichario* fichario) {
	...
	al_draw_text(fichario->posicoes->descricao, al_map_rgb(145, 135, 86), x_box_subtitle, y_box_subtitle, ALLEGRO_ALIGN_CENTER, "Classifique o animal desconhecido com base nas informacoes.");
