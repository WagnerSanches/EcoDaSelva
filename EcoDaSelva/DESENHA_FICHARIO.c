...
void desenhar_box(struct Fichario* fichario) {
	...
	al_draw_filled_rectangle(fichario->posicoes->espacamento_fichario_fora, fichario->posicoes->espacamento_fichario_fora, x_box_final, y_box_final, al_map_rgb(255, 255, 170));
