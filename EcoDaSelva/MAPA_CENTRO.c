...
void carregar_mapa_centro(struct al_mapa *mapa) {
	...
	mapa->npc[1]->foto = al_load_bitmap("assets/npc/foto/mapa_centro/npc_um_resize.jpg");
	...
	mapa->npc[2]->foto = al_load_bitmap("assets/npc/foto/mapa_centro/npc_um_resize.jpg");

	strcpy(mapa->npc[3]->nome, "Arariboia");
	mapa->npc[3]->foto = al_load_bitmap("assets/npc/foto/mapa_centro/npc_um_resize.jpg");
