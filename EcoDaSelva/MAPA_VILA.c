...
void carregar_mapa_vila(struct al_mapa* mapa) {
	...
	strcpy(mapa->npc[1]->dialogo[1]->texto, "Sera que voce consegue encontrar alguns buritis ? Geralmente os buritis sao vermelhos e ficam no sul a esquerda da vila, perto das palmeiras. Eu nao tive muita sorte, tomara que voce tenha.");
